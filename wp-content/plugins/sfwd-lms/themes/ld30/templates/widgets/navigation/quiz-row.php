...
$classes = array(
	...
	'wrapper'   => 'ld-lesson-item-preview' . ( get_the_ID() === $quiz['post']->ID ? ' ld-is-current-item ' : '' ),
...
if ( isset( $context ) && 'lesson' === $context ) {
	...
	$classes['anchor']    = 'ld-table-list-item-preview ld-primary-color-hover' . ( get_the_ID() === $quiz['post']->ID ? ' ld-is-current-item ' : '' );
