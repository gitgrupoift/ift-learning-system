...
/**
 * Get the user's last active (last updated) course_id
 *
 * @since 2.1.3
...
/**
 * Get the user's last active step within a course_id
 *
 * @since 2.1.3
 * @param interger $user_id User ID.
 * @param interger $course_id Course ID.
 * @return integer Course Step ID.
 */
